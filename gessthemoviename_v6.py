...
#############################################################################
def guesstheMovieName(plr1Points,plr2Points):
    ...
    return ('player 1:', plr1Points,'Player 2 :' ,plr2Points)
...
if (plr1play == 1) and (plr2Play == 1):
    guesstheMovieName(plr1Points,plr2Points)
    print(guesstheMovieName(plr1Points,plr2Points))
